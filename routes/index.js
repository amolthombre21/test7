...
var secretKey="29FD1B2C735A2E91CDE9E26CA267F";
...
exports.index = function(req, res) {
	...
	// direct way
	client.get("http://gumball-lab4gumball.rhcloud.com/", function(data,
			response) {
	...
	if (action === 'TurnTheCrank' && state === 'HasACoin') {
		...
		client.get("http://gumball-lab4gumball.rhcloud.com/", function(data,
			...
			if (count !== 0) {
				...
				client.put("http://gumball-lab4gumball.rhcloud.com/gumball/1", args,
